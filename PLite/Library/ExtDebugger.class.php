...
class ExtDebugger {
    ...
    <div style="border-left:thin double #ccc;position: fixed;bottom:0;right:0;font-size:14px;width:1280px;z-index: 999999;color: #000;text-align:left;font-family:'Times New Roman';cursor:default;">
        <div id="page_trace_tab" style="display: none;background:white;margin:0;height: 512px;">
            <!-- 导航条 -->
            <div id="page_trace_tab_tit" style="height:32px;padding: 6px 12px 0;border-bottom:1px solid #ececec;border-top:1px solid #ececec;font-size:16px">
                {$nav}
            </div>
            <!-- 详细窗口 -->
            <div id="page_trace_tab_cont" style="overflow:auto;height:478px;padding: 0; line-height: 24px">
                {$win}
            </div>
        </div>
        <!-- 关闭按钮 -->
